      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <article key={post.id} className="group relative flex flex-col bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-sky-100/50 transition-all duration-300 hover:-translate-y-2 p-6">
               ...
               <div className="mt-4 pt-4 border-t border-slate-50">
                 <button className="text-sky-500 font-bold text-xs uppercase tracking-wider hover:text-sky-600 transition-colors">Leer más &rarr;</button>
               </div>
            </article>
          ))}
        </div>
